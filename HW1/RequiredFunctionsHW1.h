...
/*============================
        Write to File
==============================*/
static void Write_File(char fileName[], char input[]){
  FILE *pFile;
...
/*============================
        ...
        (Unused in HW1)
==============================*/
static unsigned char* PRNG(unsigned char *seed, size_t seed_len, size_t output_len)
{
...
/*============================
        Showing in Hex 
==============================*/
static void Show_in_Hex (char name[], unsigned char input[], int inputlen)
{
...
=====================================*/
static void Convert_To_Uchar(char* input_hex, unsigned char output[], int output_len)
{   
...
================================*/
static void Concatenation32(unsigned char a[32], unsigned char b[32], unsigned char c[64]){
    memcpy(c, a, 32);
    memcpy(c+32, b, 32);
}
...
*/
static void Concatenation(unsigned char* in1, size_t in1len, unsigned char* in2, size_t in2len, unsigned char* out, size_t outlen){
...
static unsigned char* Hash_Blake2s(unsigned char* input, unsigned long inputlen) {
...
*/
static unsigned char* HMAC_SHA256(const unsigned char *key, int key_n,
